...
#define SBC(data)                                                              \
  {                                                                            \
    ...
    if (flags & FD) {                                                          \
      ...
      if (tempval2 & 0x10)                                                     \
        tempval2 =                                                             \
            ((tempval2 - 6) & 0xf) | ((a & 0xf0) - (tempval & 0xf0) - 0x10);   \
      else                                                                     \
...
void initcpu(unsigned short newpc, unsigned char newa, unsigned char newx,
             unsigned char newy);
int runcpu(void);
...
void setpc(unsigned short newpc) { pc = newpc; }
